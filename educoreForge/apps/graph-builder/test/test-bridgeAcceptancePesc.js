...
const P1_BASELINE_COMMIT = 'postJudgeRegistryJob4-090726'; // re-anchored by DAWN_TOWER after each judgeProviderRegistry job (JOB 0 through JOB 3, 2026-09-07); the tag is cut on the last commit that touches a watched path, and this suite's own path is not watched
