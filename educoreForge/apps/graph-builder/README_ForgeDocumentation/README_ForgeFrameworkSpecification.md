...
> S3, S7, C10, S6 in the kit, P13 re-filed, P5 four); §7.3 (single frozen counts + conditional rows);
...
- **Two precondition kinds.** A **forge-time** row has a precondition the framework evaluates on the
  build it is running (E6/S4/P16, S2, S3, S7, P2, P3, P4, P6, P9, C1, C2, C10, S6). An
