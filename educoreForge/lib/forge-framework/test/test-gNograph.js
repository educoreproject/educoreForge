...
const FROZEN_FORGE_TIME_FILE_COUNT = 16; // lib/forge-framework/*.js (SPEC §12.1 tree; +3 embed-text modules, P3 2026-09-14: embedTextDerivation, embedTextPass, frameworkNonEmbeddableRoles)
