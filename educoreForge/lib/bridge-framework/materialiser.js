...
const edgePropertiesFor = ({ record, block, decisionBlockHash, sourceStandardName, sourceVersion, hubName, hubVersion, mappingProviderUrl, subjectMatchField, objectMatchField, debugMark }) => {
	const edgeProperties = {
		...
		[MAPPING_PROPERTIES.MAPPING_JUSTIFICATION]: JUSTIFICATION_BY_RESOLUTION[record.resolution],
		[MAPPING_PROPERTIES.MATCH_BASIS]: block.header.matchBasis,
		[MAPPING_PROPERTIES.RESOLUTION]: record.resolution,
		[MAPPING_PROPERTIES.MAPPING_PROVIDER]: mappingProviderUrl,
		[MAPPING_PROPERTIES.SUBJECT_MATCH_FIELD]: subjectMatchField,
...
const materialiseBlock = ({ block, decisionBlockHash, writer, sourceStandardName, sourceVersion, hubName, hubVersion, mappingProviderUrl, subjectMatchField, objectMatchField, debugMark } = {}, callback) => {
