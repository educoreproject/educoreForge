...
frameworkMutationTwin({ registry: twinRegistry, gateId: 'BG-P3', conjunctId: 'b_zeroIsOrphanWithReason', twinName: 'noOrphanRecordOnZero', fileName: FRAMEWORK_FILE, find: "\t\t\t\t\t\t\tif (classified.classification === 'orphan') {\n\t\t\t\t\t\t\t\tdecisionRecordList.push({ ...baseRecord, resolution: null, objectStableId: null, predicate: null, reason: baseRecord.remodelApplied", replace: "\t\t\t\t\t\t\tif (classified.classification === 'orphan') {\n\t\t\t\t\t\t\t\treturn;\n\t\t\t\t\t\t\t\tdecisionRecordList.push({ ...baseRecord, resolution: null, objectStableId: null, predicate: null, reason: baseRecord.remodelApplied" });
...
frameworkMutationTwin({ registry: twinRegistry, gateId: 'BG-TENTATIVE', conjunctId: 'b_sourceLabelRawAndAssertedByLabelTable', twinName: 'dropSourceLabel', fileName: FRAMEWORK_FILE, find: "predicateAssertedBy: labelRow.predicateAssertedBy, sourceLabel: labelRow.sourceLabel };", replace: "predicateAssertedBy: labelRow.predicateAssertedBy, sourceLabel: null };" });
