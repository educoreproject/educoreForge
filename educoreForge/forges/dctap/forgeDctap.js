...
// PORTED (grand recreation): the substrate is vendored into the new tree's own lib/. Incumbent
// climb was __dirname/../../../npm/qtools-graph-forge-core/lib; the new tree carries search-text,
// snapshot-provenance, vocabulary and structural-contract under educoreForge/lib/, reached from
// forges/dctap/ as ../../lib. The ONE deliberate edit to an otherwise byte-faithful bundle (mirrors
// forge-ctdl / forge-ctdlasn / forge-lif). NOTE: the incumbent climb would STILL resolve from here
// (to code/npm/qtools-graph-forge-core/lib, which exists) — a silent wrong-substrate trap — so this
