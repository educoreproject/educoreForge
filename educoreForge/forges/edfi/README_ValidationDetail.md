...
the evidence behind each figure, the derived reading of the canonicalizer's source, the declared
equivalence policy in full, the gate-2 attribution defect, and the commands to reproduce the run.
